...
public class StartupIntentReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
	    ...
	    SharedPreferences settings = context.getSharedPreferences(CSSettings.CS_PREFS,
	            Context.MODE_MULTI_PROCESS);
	    if (settings.getBoolean("start_on_boot",
	            context.getResources().getBoolean(R.bool.start_on_boot))) {
